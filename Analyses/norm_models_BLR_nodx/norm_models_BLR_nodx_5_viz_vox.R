...
for (t in 1:length(tissues)) {
    vox_tissue[[t]] = subset(nm[[1]][[t]], N>5000, select=c("ROI", "N"))
}
...
# command = "python ./save_vox_micro_label.py"
# system(command)

inclusions = as.data.frame(fread("../../QC/inclusions_nodx_inputNM.txt"))
